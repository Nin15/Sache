      ...
      <div className="relative w-full gap-2 flex flex-col items-center justify-center">
        <div className="max-w-4xl mt-20 mx-auto px-4 py-12">
          ...
          <div className="space-y-6">
            {services.map((service, index) => (
              <motion.div
                ...
                className="bg-[#1c1c1c] border border-gray-700 p-5 rounded-xl shadow-md flex items-start gap-3 transition-all duration-300 motion-slide"
              >
          ...
          <motion.div
            ...
            className="mt-12 text-center motion-scale"
          >
