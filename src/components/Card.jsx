...
export default function Card({ name, position, description, image }) {
  return (
    <div
      className={`bg-white flex relative justify-around items-center flex-col  opacity-80 shadow-lg w-[270px] h-[320px] rounded-4xl p-5 transform transition duration-300 hover:scale-105 hover:opacity-100 ${
        position === "დირექტორის მოადგილე" ? "mt-41 md:mt-0 text-center" : ""
      }`}
    >
      <img className="absolute w-[230px]  rounded-full top-[-130px]" src="/Logo.png" alt="Logo" />
